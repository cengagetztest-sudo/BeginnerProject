...
- [StickHero](https://github.com/Namitjain07/STICKHERO) - A simple stick-bridge arcade game built using Java/JavaFX with animations, sound effects, scoring, and clean architecture.
